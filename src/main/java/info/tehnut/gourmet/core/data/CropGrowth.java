...
public final class CropGrowth {
    ...
    public static final CropGrowth DEFAULT = new CropGrowth(3, 1, Stages.SEVEN, true, 9);
    ...
    public CropGrowth(int maxSeedDrop, int maxProduceDrop, Stages stages, boolean canFertilize, int minLight, int maxLight) {
    ...
    public CropGrowth(int maxSeedDrop, int maxProduceDrop, Stages stages, boolean canFertilize, int minLight) {
    ...
    public enum Stages {
        THREE(Properties.AGE_3),
        FIVE(Properties.AGE_5),
        SEVEN(Properties.AGE_7),
        ;

        private final IntegerProperty property;

        Stages(IntegerProperty property) {
    ...
    public static class Serializer implements JsonSerializer<CropGrowth>, JsonDeserializer<CropGrowth> {
        ...
        public CropGrowth deserialize(JsonElement element, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            Stages stages = json.has("stages") ? Stages.valueOf(json.getAsJsonPrimitive("stages").getAsString()) : DEFAULT.stages;
        ...
        public JsonElement serialize(CropGrowth src, Type typeOfSrc, JsonSerializationContext context) {
            ...
            jsonObject.addProperty("stages", src.stages.name());
