...
public class DumbassHarvestXMLParser extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        switch (qName) {
            ...
            case "effect": {
                Identifier effect = (Identifier) dataStorage.get("effect_effect");
                ...
                builder.addEffect(new EatenEffect(effect, amplifier, duration, chance));
                break;
            }
        }
    }
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        ...
        switch (available) {
            ...
            // Effects
            case "effect": {
                dataStorage.put("effect_effect", new Identifier(value));
                break;
            }
        }
    }
