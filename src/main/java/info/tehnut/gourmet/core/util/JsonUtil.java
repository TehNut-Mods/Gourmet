...
import info.tehnut.gourmet.core.data.BushGrowth;
import info.tehnut.gourmet.core.data.CropGrowth;
...
public class JsonUtil {
    ...
    private static final Gson GSON = new GsonBuilder()
            ...
            .disableHtmlEscaping()
            .serializeNulls()
            .registerTypeAdapter(Harvest.class, new Harvest.Serializer())
            .registerTypeAdapter(BushGrowth.class, new BushGrowth.Serializer())
            .registerTypeAdapter(CropGrowth.class, new CropGrowth.Serializer())
            .registerTypeAdapter(EatenEffect.class, new EatenEffect.Serializer())
            .create();
